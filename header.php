...
<?php esc_html_e( 'Skip to content', 'skt-lights' ); ?>
</a>
<?php
...
?>
<div id="main-set">
<div class="head-info-pattern"></div>
<div class="container">
<div class="header">	
    <div class="logo">
		<?php skt_lights_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
		...
		<?php wp_nav_menu( array('theme_location' => 'primary', 'container' => 'ul', 'menu_id' => 'primary', 'menu_class' => 'primary-menu menu' ) ); ?>
                        	...
                        	<div class="header-search-toggle"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/images/icon-search.png"/></div>
                


            	<div class="header-search-form">
                    <form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                      <input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Search', 'skt-lights' ); ?>" name="s">
                      <input type="submit" class="search-submit" value="<?php esc_attr_e( 'Search', 'skt-lights' ); ?>">
                    </form>
          		</div>
...
<?php if ( class_exists( 'WooCommerce' ) ) { ?>
            <div class="header-cart">
            	<a class="cart-customlocation" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'skt-lights' ); ?>"> <img class="cart-customlocation" src="<?php echo esc_url(get_stylesheet_directory_uri());?>/images/cart-icon.png" /> <span class="custom-cart-count"><div id="mini-cart-count"></div></span> </a>  
            </div>   
            <?php } ?>
